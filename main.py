...
from sklearn.metrics import cohen_kappa_score, accuracy_score, ConfusionMatrixDisplay, confusion_matrix
...
def train(dataset_conf, train_conf, results_path):
    ...
    for sub in range(n_sub):  # (num_sub): for all subjects, (i-1,i): for the ith subject.
        ...
        X_train, _, y_train_onehot, _, _, _ = get_data(
            data_path, sub, dataset, isStandard=isStandard)
        ...
        for train in range(n_train):  # How many repetitions of training for subject i.
            ...
            # Evaluate the performance of the trained model based on the validation dataset
...
def test(model, dataset_conf, results_path, allRuns=True):
    ...
    for sub in range(n_sub):  # (num_sub): for all subjects, (i-1,i): for the ith subject.
        # Load data
        _, _, _, X_test, _, y_test_onehot = get_data(data_path, sub, dataset, isStandard=isStandard)
